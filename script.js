let product = {
    ...
    BestBurger: {
        ...
        amount: 0,
        kcall: 3300,
        img: "https://vilkin.pro/wp-content/uploads/2018/09/domashnie-burgery-13.jpg",
        descr: 'Просто топ',
        get Summ() {
            return this.price * this.amount
        },
...
receiptBtn.addEventListener('click', function() {
    ...
    let block = document.querySelectorAll('.main__product-info'),
        images = document.querySelectorAll('.main__product-img'),
        view = document.querySelector('.view'),
        img = document.querySelector('.view img'),
        close = document.querySelector('.view__close');

        for(let i = 0; i < block.length;i++){
            block[i].addEventListener('dblclick', () => {
